...
def test_handle_subscribe_request_with_success_wonderware(managed_feeds_postgres_manager_wonderware,
    ...
    postgres_session_wonderware.add_all([
        *feed_list,
        SubscribeEvent(
    ...
    managed_feeds_postgres_manager_wonderware.handle_subscribe_request(composition_event_id, payload)

    postgres_session_wonderware.expire_all()

    event = postgres_session_wonderware.query(Event).get('cd485049-2f6f-4355-8970-05abb5fda70c')
