...
@pytest.fixture()
def managed_feeds_dynamo_dao(dynamodb_resource, pi_points_dynamo_table, events_status_table, s3_client):
    return ManagedFeedsDynamodbDao(
        dynamodb_resource,
        pi_points_dynamo_table.table_name,
        events_status_table.table_name,
        s3_client
    )


@pytest.fixture()
def managed_feeds_manager(s3_resource, sqs_service, managed_feeds_dynamo_dao):
    return ManagedFeedsManager(s3_resource, sqs_service, managed_feeds_dynamo_dao)
