...
import {
    Col, FormGroup, Tooltip, OverlayTrigger, FormControl
    ...
    renderQuery() {
        return (
            <React.Fragment>
                ...
                />
                <FormGroup>
                    <FormControl.Static>Note that queries that fetch too much data could be timed out by server!</FormControl.Static>
                </FormGroup>
            </React.Fragment>
        )
    }
