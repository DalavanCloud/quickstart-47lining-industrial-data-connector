...
export default class SearchResults extends Component {
    ...
    render() {
        const { searchResults, selectAsset, selectedAsset, searchFilters, activePage, sizePerPage, onPageChange, loading } = this.props;
        ...
        return (
            <Fragment>
                <SearchResultsHeader
                    ...
                    feedsTotalCount={searchResults.pi_points_total_count}
